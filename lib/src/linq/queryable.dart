...
//: `sql/query_provider.dart` was the
// engine-specific `SqliteQueryProvider`.
// In 2.0.0, the `Queryable<T>` in d_rocket
// core uses the engine-agnostic
// [LegacySyncQueryProvider] interface
// (also in d_rocket core, re-exported by
// the d_rocket barrel above). The SQLite
// engine's `SqliteQueryProvider` implements
// this interface, so the runtime behaviour
// is unchanged.
